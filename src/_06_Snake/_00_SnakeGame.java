...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Be a Snake";
	...
	private void setFoodLocation() {
		...
		while(snake.isLocationOnSnake(loc)) {
			loc = new Location((int) (Math.random() * WIDTH), (int) (Math.random() * HEIGHT));
		}
		foodLocation = loc;
	}
	...
	private void gameOver() {
		...
		// else, exit the game
		String choice = JOptionPane.showInputDialog(window,
				"Do you want to play again. If so type 0 to restart or 1 to stop.");
